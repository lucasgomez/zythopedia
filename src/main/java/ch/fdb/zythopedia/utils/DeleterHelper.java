...
public final class DeleterHelper {
    ...
    public static <E extends HasId, C> Void delete(String entityName, String childrenEntityName, Long entityIdToDelete, IdOrNameDto entityIdToTransferTo,
    ...
    private static <E extends HasId, C> void transfer(String entityName, String childrenEntityName, E entityToDelete, E entityToTransferTo, Function<E, Collection<C>> childrenMapper, BiFunction<C, E, C> parentSetter) {
